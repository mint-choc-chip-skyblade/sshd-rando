...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        sizePolicy2.setHeightForWidth(self.other_settings_group_box.sizePolicy().hasHeightForWidth())
        self.other_settings_group_box.setSizePolicy(sizePolicy2)
...
"}")
    ...
    def retranslateUi(self, main_window):
        ...
        self.how_to_extract_label.setText(QCoreApplication.translate("main_window", u"<html><head/><body><p><span style=\" font-size:10pt;\">Before generating a seed, you need to have a valid extract of the vanilla version of the game.</span></p><p><span style=\" font-size:10pt;\">Please follow our handy setup guides for the </span><a href=\"https://docs.google.com/document/d/1VXNME7SVD5EU7NNn9dQ15_Q9-v9OJAHOX-hSor0n2dg\"><span style=\" text-decoration: underline; color:#9a0089;\">Nintendo Switch console</span></a><span style=\" font-size:10pt;\"> or for </span><a href=\"https://docs.google.com/document/d/1HHQRXND0n-ZrmhEl4eXjzMANQ-xHK3pKKXPQqSbwXwY\"><span style=\" text-decoration: underline; color:#9a0089;\">emulator</span></a><span style=\" font-size:10pt;\">.</span></p><p><span style=\" font-size:10pt;\">For additional help with this process, please join the </span><a href=\"https://discord.gg/nNbpfH5jyG\"><span style=\" text-decoration: underline; color:#9a0089;\">Discord Server</span></a><span style=\" font-size:10pt;\"> or ask on </span><a href=\"https://github.com/mint-choc-chip-skyblad"
                        "e/sshd-rando/issues\"><span style=\" text-decoration: underline; color:#9a0089;\">GitHub</span></a><span style=\" font-size:10pt;\">.</span></p></body></html>", None))
        ...
        self.choose_settings_label.setText(QCoreApplication.translate("main_window", u"<html><head/><body><p><span style=\" font-size:10pt; font-weight:700;\">Quick start: </span><span style=\" font-size:10pt;\">You can select one of the settings presets below to jump straight in!</span></p><p><span style=\" font-size:10pt;\">Don't worry if there's too much going on, the default settings are perfect for beginners.</span></p><p><span style=\" font-size:10pt;\">Alternatively, you can customize every setting yourself. There's lots of buttons and switches, so get stuck in!</span></p></body></html>", None))
        ...
        self.how_to_generate_label.setText(QCoreApplication.translate("main_window", u"<html><head/><body><p><span style=\" font-size:10pt;\">Once you're ready, click the </span><span style=\" font-family:'Courier New'; font-size:10pt;\">Randomize</span><span style=\" font-size:10pt;\"> button in the bottom right.</span></p><p><span style=\" font-size:10pt;\">The program will begin to generate a game patch that will allow you to play the randomizer.</span></p><p><span style=\" font-size:10pt;\">If you encounter a problem, don't hesitate to ask for help! You can join the </span><a href=\"https://discord.gg/nNbpfH5jyG\"><span style=\" font-size:10pt; text-decoration: underline; color:#9a0089;\">Discord Server</span></a><span style=\" font-size:10pt;\"> or ask on </span><a href=\"https://github.com/mint-choc-chip-skyblade/sshd-rando/issues\"><span style=\" font-size:10pt; text-decoration: underline; color:#9a0089;\">GitHub</span></a><span style=\" font-size:10pt;\">!</span></p></body></html>", None))
